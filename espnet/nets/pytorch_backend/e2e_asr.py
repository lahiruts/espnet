...
class MultiE2E(torch.nn.Module):
    """E2E module
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        if self.mtlalpha == 1:
            ...
            loss_att, acc = self.dec(hs_pad, gs_pad, hlens, ys_pad)
        self.acc = acc
    ...
    def recognize(self, x, recog_args, char_list, rnnlm=None):
        ...
        # 2. decoder
        # decode the first utterance
        y = self.dec.recognize_beam(h[0], gh[0], lpz, recog_args, char_list, rnnlm)
    ...
    def calculate_all_utterance_attentions(self, xs_pad, ilens, ys_pad):
        """E2E attention calculation
