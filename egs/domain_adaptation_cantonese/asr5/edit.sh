...
daconfig=7_100_-1   #input the configs 3_1_2_5 format
# data
...
expdir=smartone_data/100_fhl
feat_tr_dir=smartone_data/data_100_fhl
workingdir=smartone_data/100_fhl/results_${epochs}
mkdir -p ${expdir}
mkdir -p ${workingdir}
